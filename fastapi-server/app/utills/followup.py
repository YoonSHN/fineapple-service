...
def is_follow_up(current_intent: str, previous_intent: Optional[str], question: Optional[str] = "") -> bool:
    ...
    intent_groups = [
        {"주문조회", "주문상태", "배송조회", "배송", "거래내역", "주문번호", "주문취소","주문상세","장바구니"},
        {"결제", "환불", "결제수단", "할인", "영수증", "세금계산서","보증","영수증/세금계산서"},
        {"반품", "교환", "환불요청", "수거", "회수", "교환요청","재입고문의"},
        {"계정", "로그인", "비밀번호", "회원탈퇴", "포인트", "적립", "등급"},
        {"제품비교", "재고", "스펙", "호환성", "사양", "브랜드", "추천", "가격", "결제","제품추천","설치/사용법","업데이트/펌웨어"},
        {"인사", "감사", "잡담", "이벤트", "운영시간"},
        {"비관련", "광고", "스팸"},
    ]

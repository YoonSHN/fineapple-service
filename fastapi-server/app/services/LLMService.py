...
5. 형식 예시:
        ...
        known_intents = {
            "주문조회", "배송조회", "배송", "주문취소", "환불", "교환", "반품",
            "결제", "포인트", "계정", "거래내역", "주문상세", "제품추천", "고객센터",
            "제품비교", "잡담", "비관련", "unknown"
        }
        ...
        try:
            ...
            if intent in ("제품비교", "제품추천"):
                unrelated_keywords = ["게임", "영화", "드라마", "연애", "여행", "날씨", "유튜브"]
                if any(k in question for k in unrelated_keywords):
                    intent = "비관련"
